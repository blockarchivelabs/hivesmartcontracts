...
const witnessesContractPayload = setupContractPayload(
  "witnesses",
  "./contracts/witnesses.js",
  (contractCode) =>
    contractCode
      .replace(/NB_TOP_WITNESSES = .*;/, "NB_TOP_WITNESSES = 4;")
      .replace(
        /MAX_ROUND_PROPOSITION_WAITING_PERIOD = .*;/,
        "MAX_ROUND_PROPOSITION_WAITING_PERIOD = 20;"
      )
      .replace(
        /NB_WITNESSES_SIGNATURES_REQUIRED = .*;/,
        "NB_WITNESSES_SIGNATURES_REQUIRED = 3;"
      )
);
...
function addGovernanceTokenTransactions(fixture, transactions, blockNumber) {
  ...
  transactions.push(
    new Transaction(
      ...
      "tokens",
      "issue",
      `{ "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "to": "${CONSTANTS.STEEM_ENGINE_ACCOUNT}", "quantity": "1500000", "isSignedWithActiveKey": true }`
    )
  );
}
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "contract",
          "deploy",
          JSON.stringify(witnessesContractPayload)
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.255.123.254", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "STM7sw22HqsXbz7D2CmJfmMwt9rimtk518dRzsR1f8Cgw52dQR1pR", "enabled": true, "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.255.123.253", "RPCPort": 7000, "P2PPort": 8000, "signingKey": "STM8T4zKJuXgjLiKbp6fcsTTUtDY7afwc4XT9Xpf6uakYxwxfBabq", "enabled": false, "isSignedWithActiveKey": true }`
        )
      );
      ...
      assert.equal(
        witnesses[1].signingKey,
        "STM8T4zKJuXgjLiKbp6fcsTTUtDY7afwc4XT9Xpf6uakYxwxfBabq"
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.255.123.123", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "STM7sw22HqsXbz7D2CmJfmMwt9rimtk518dRzsR1f8Cgw52dQR1pR", "enabled": false, "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.255.123.124", "RPCPort": 7000, "P2PPort": 8000, "signingKey": "STM8T4zKJuXgjLiKbp6fcsTTUtDY7afwc4XT9Xpf6uakYxwxfBabq", "enabled": true, "isSignedWithActiveKey": true }`
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.234", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "STM7sw22HqsXbz7D2CmJfmMwt9rimtk518dRzsR1f8Cgw52dQR1pR", "enabled": true, "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.233", "RPCPort": 7000, "P2PPort": 8000, "signingKey": "STM8T4zKJuXgjLiKbp6fcsTTUtDY7afwc4XT9Xpf6uakYxwxfBabq", "enabled": false, "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "stake",
          `{ "to": "${CONSTANTS.STEEM_ENGINE_ACCOUNT}", "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "100", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "approve",
          `{ "witness": "dan", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "approve",
          `{ "witness": "vitalik", "isSignedWithActiveKey": true }`
        )
      );
      ...
      assert.equal(approvals[0].from, CONSTANTS.STEEM_ENGINE_ACCOUNT);
      assert.equal(approvals[0].to, "dan");

      assert.equal(approvals[1].from, CONSTANTS.STEEM_ENGINE_ACCOUNT);
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.245", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "STM7sw22HqsXbz7D2CmJfmMwt9rimtk518dRzsR1f8Cgw52dQR1pJ", "enabled": true, "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "stake",
          `{ "to": "ned", "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "0.00001", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "approve",
          `{ "witness": "satoshi", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      assert.equal(accounts[0].account, CONSTANTS.STEEM_ENGINE_ACCOUNT);
      ...
      assert.equal(approvals[2].from, CONSTANTS.STEEM_ENGINE_ACCOUNT);
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.233", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "STM7sw22HqsXbz7D2CmJfmMwt9rimtk518dRzsR1f8Cgw52dQR1pR", "enabled": true, "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.232", "RPCPort": 7000, "P2PPort": 8000, "signingKey": "STM8T4zKJuXgjLiKbp6fcsTTUtDY7afwc4XT9Xpf6uakYxwxfBabq", "enabled": false, "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.231", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "STM7sw22HqsXbz7D2CmJfmMwt9rimtk518dRzsR1f8Cgw52dQR1pJ", "enabled": true, "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "register",
          `{ "IP": "123.234.123.234", "RPCPort": 7000, "P2PPort": 8000, "signingKey": "STM8T4zKJuXgjLiKbp6fcsTTUtDY7afwc4XT9Xpf6uakYxwxfBabq", "enabled": false, "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "stake",
          `{ "to": "${CONSTANTS.STEEM_ENGINE_ACCOUNT}", "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "0.00001", "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "stake",
          `{ "to": "ned", "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "1", "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "delegate",
          `{ "to": "ned", "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "2", "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "undelegate",
          `{ "from": "ned", "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "2", "isSignedWithActiveKey": true }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "unstake",
          `{ "symbol": "${CONSTANTS.GOVERNANCE_TOKEN_SYMBOL}", "quantity": "1", "isSignedWithActiveKey": true }`
        )
      );
  ...
  it("schedules witnesses", (done) => {
    new Promise(async (resolve) => {
      ...
      for (let index = 0; index < 100; index++) {
        ...
        const wif = dhive.PrivateKey.fromLogin(
          witnessAccount,
          "testnet",
          "active"
        );
        transactions.push(
          new Transaction(
            ...
            "witnesses",
            "register",
            `{ "IP": "123.123.123.${index}", "RPCPort": 5000, "P2PPort": 6000, "signingKey": "${wif
              .createPublic("TST")
              .toString()}", "enabled": true, "isSignedWithActiveKey": true }`
          )
        );
      }
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "issueToContract",
          `{ "to": "witnesses", "symbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "quantity": "1000", "isSignedWithActiveKey": true, "callingContractInfo": { "name": "mining" } }`
        )
      );
      ...
      for (let i = 1; i < NB_WITNESSES; i++) {
        ...
        block = {
          refSteemBlockNumber: 100000000 + i,
          refSteemBlockId: "ABCD1",
          prevRefSteemBlockId: "ABCD2",
      ...
      transactions.push(
        new Transaction(
          ...
          "witnesses",
          "updateParams",
          '{"numberOfTopWitnesses": 20, "numberOfWitnessSlots": 21, "witnessSignaturesRequired": 14}'
        )
      );
      block = {
        refSteemBlockNumber: 100000005,
        refSteemBlockId: "ABCD1",
        prevRefSteemBlockId: "ABCD2",
      ...
      while (blockNum <= endBlockRound) {
        ...
        if (blockFromNode !== null) {
          calculatedRoundHash = SHA256(
            `${calculatedRoundHash}${blockFromNode.hash}`
          ).toString(enchex);
        }
        blockNum += 1;
      }
  ...
  it("generates a new schedule once the current one is completed", (done) => {
    new Promise(async (resolve) => {
      ...
      for (let i = 1; i < NB_WITNESSES; i++) {
        ...
        block = {
          refSteemBlockNumber: refBlockNumber,
          refSteemBlockId: `ABCD1234`,
          prevRefSteemBlockId: `ABCD1233`,
          timestamp: `2018-06-01T00:00:0${i}`,
          transactions,
        };
      ...
      assert.equal(
        params.currentWitness,
        newSchedule[newSchedule.length - 1].witness
      );
      assert(
        params.lastWitnesses.includes(
          newSchedule[newSchedule.length - 1].witness
        )
      );
  ...
  it("changes the current witness if it has not validated a round in time", (done) => {
    new Promise(async (resolve) => {
      ...
      for (let index = 30; index < 51; index++) {
        ...
        block = {
          refSteemBlockNumber: 100000001 + index,
          refSteemBlockId: "ABCD1",
          prevRefSteemBlockId: "ABCD2",
      ...
      assert.equal(
        ...
        '[{"_id":1,"witness":"witness8","blockNumber":2,"round":1},{"_id":2,"witness":"witness7","blockNumber":3,"round":1},{"_id":3,"witness":"witness9","blockNumber":4,"round":1},{"_id":4,"witness":"witness5","blockNumber":5,"round":1},{"_id":5,"witness":"witness10","blockNumber":6,"round":1}]'
      );
