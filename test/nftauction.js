...
const nftauctionContractPayload = setupContractPayload(
  "nftauction",
  "./contracts/nftauction.js"
);
  ...
  if (!reverse) {
    ...
    if (bidIndex) {
      assert.equal(
        res.currentLead,
        bidIndex,
        `expected currentLead to be ${bidIndex} instead got ${res.currentLead}`
      );
    }
...
async function assertBalances(accounts, balances, symbol) {
  ...
  for (let i = 0; i < accounts.length; i += 1) {
    ...
    const { balance } = res.find((el) => el.account === account);
    ...
    assert(
      isEqual,
      `expected @${account} balance ${expectedBalance} instead got ${balance}`
    );
  }
}
...
describe("NFT Auction Smart Contract", function () {
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "contract",
          "deploy",
          JSON.stringify(nftauctionContractPayload)
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "agentFeePercent": 15000 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "minFeePercent": 100.0001 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "minFeePercent": 100 }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "agentFeePercent": 500 }'
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "minFeePercent": 50 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "officialMarket": "splinterlands", "agentFeePercent": 1200 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "officialMarket": "peakmonsters", "agentFeePercent": 1100, "minFeePercent": 250 }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nft",
          "updateParams",
          `{ "nftCreationFee": "1", "nftIssuanceFee": {"${CONSTANTS.UTILITY_TOKEN_SYMBOL}":"0.01"} }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"ali-h", "quantity":"1.01", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": false, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00" }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00" }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": 0, "expiry": "2021-03-20T00:00:00" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": 1 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "PAY", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "-1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.00000000000005", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "-100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100.55555555555555", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2020-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2022-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"ali-h", "quantity":"1", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["2", "3"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "setMarketParams",
          '{ "isSignedWithActiveKey": true, "symbol": "TEST", "officialMarket": "broker", "agentFeePercent": 1100, "minFeePercent": 250 }'
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nft",
          "issue",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "to": "ali-h", "feeSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}" }`
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 0 }`
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": false, "auctionId": "AUCTION-TX", "bid": "19" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "--" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": 45, "bid": "12" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "545131", "bid": "15", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "-5", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "0.000000000000005", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "0.05", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "16.9", "marketAccount": "mart" }'
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "0.5", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "0.3", "marketAccount": "mart" }'
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "15", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "15", "marketAccount": 520}'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"dev", "quantity":"100", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"bidmaker", "quantity":"100", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "19", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "13", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "25", "marketAccount": "mart" }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "50", "marketAccount": "mart1" }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-13T00:00:00", "feePercent": 0 }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "10", "marketAccount": "mart" }'
        )
      );
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "cancelBid",
          '{ "isSignedWithActiveKey": false, "auctionId": "AUCTION-TX" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "cancelBid",
          '{ "isSignedWithActiveKey": true, "auctionId": 452 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "cancelBid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX52" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "cancelBid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX" }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"dave", "quantity":"100", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"jhonny", "quantity":"100", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "21.5", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "12.5", "marketAccount": "mart" }'
        )
      );
      ...
      await assertBalances(["dave"], ["100"], "ENG");
      ...
      await assertBalances(["jhonny"], ["100"], "ENG");
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "10.049", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "10.04", "marketAccount": "mart" }'
        )
      );
      transactions.push(
        new Transaction(
      ...
      await assertBalances(["cryptomancer"], ["100"], "ENG");
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "cancel",
          '{ "isSignedWithActiveKey": true, "auctionId": 456 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "cancel",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TXas" }'
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "settle",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "account": 54 }'
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "settle",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "account": "jojo" }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"ali-h", "quantity":"2.01", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "bid",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "bid": "100", "marketAccount": "mart" }'
        )
      );
      ...
      await assertBalances(
        ["cryptomancer", "dave", "bidmaker", "ali-h", "mart"],
        ["100", "100", "0", "99", "1"],
        "ENG"
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "settle",
          '{ "isSignedWithActiveKey": true, "auctionId": "AUCTION-TX", "account": "bidmaker" }'
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["1"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 300 }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      await assertNFTInstances("cryptomancer", "u", [1], "TEST");
      await assertBalances(
        ["cryptomancer", "dave", "bidmaker", "ali-h", "mart", "broker"],
        ["90", "100", "100", "9.7", "0.033", "0.267"],
        "ENG"
      );
  ...
  it("automatically settles an auction", (done) => {
    new Promise(async (resolve) => {
      ...
      const settleEvent = virtualEventLog.events.find(
        (x) => x.event === "settleAuction"
      );
  ...
  it("automatically expires an auction", (done) => {
    new Promise(async (resolve) => {
      ...
      const res = await fixture.database.getLatestBlockInfo();
      const virtualEventLog = JSON.parse(res.virtualTransactions[0].logs);
      const expireEvent = virtualEventLog.events.find(
        (x) => x.event === "expireAuction"
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"ali-h", "quantity":"3.02", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "nftauction",
          "create",
          `{ "isSignedWithActiveKey": true, "symbol": "TEST", "nfts": ["2"], "minBid": "0.1", "finalPrice": "100", "priceSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "expiry": "2021-03-20T00:00:00", "feePercent": 100 }`
        )
      );
      ...
      let expireEvent = virtualEventLog.events.find(
        (x) => x.event === "expireAuction"
      );
      ...
      expireEvent = virtualEventLog.events.find(
        (x) => x.event === "expireAuction"
      );
