...
describe("Airdrops Smart Contract", function () {
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": false, "symbol": "TKN", "type": "transfer", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": 1, "type": "transfer", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": 1, "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": 1 }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "liquid_transfer", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN.TEST", "type": "transfer", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "stake", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [[]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["harpagon"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["harpagon", "harpagon"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["harpagon", "-100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["harpagon", "100.000000001"]] }'
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"]] }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to": "ali-h", "quantity": "0.3", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to": "ali-h", "quantity": "101", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "issue",
          '{ "symbol": "TKN", "to": "ali-h", "quantity": "500", "isSignedWithActiveKey": true }'
        )
      );
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "transfer", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"],["leo.voter", "50"],["aggroed", "50"],["cryptomancer", "30"],["token-raindrops", "20"],["hive-engine", "50"]] }'
        )
      );
      ...
      const newAirdropEvent = eventLog.events.find(
        (x) => x.event === "newAirdrop"
      );
  ...
  it("should run airdrop distribution with transfer method", (done) => {
    new Promise(async (resolve) => {
      ...
      const airdropDistributionEvent = virtualEventLog.events.find(
        (x) => x.event === "airdropDistribution"
      );
      const transferFromContractEvents = virtualEventLog.events.filter(
        (x) => x.event === "transferFromContract"
      );

      assert.ok(
        airdropDistributionEvent,
        "Expected to find airdropDistribution event"
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to": "ali-h", "quantity": "1101", "isSignedWithActiveKey": true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "enableStaking",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "unstakingCooldown": 7, "numberTransactions": 1 }'
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "airdrops",
          "newAirdrop",
          '{ "isSignedWithActiveKey": true, "symbol": "TKN", "type": "stake", "list": [["harpagon", "100"],["satoshi", "100"],["theguruasia", "100"],["leo.voter", "50"],["aggroed", "50"],["cryptomancer", "30"],["token-raindrops", "20"],["hive-engine", "50"]] }'
        )
      );
      ...
      const stakeFromContractEvents = virtualEventLog.events.filter(
        (x) => x.event === "stakeFromContract"
      );
