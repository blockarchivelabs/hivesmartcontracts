...
const critterContractPayload = setupContractPayload(
  "crittermanager",
  "./contracts/crittermanager.js"
);
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "contract",
          "deploy",
          JSON.stringify(critterContractPayload)
        )
      );
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "updateParams",
          `{ "editionMapping": {"${CONSTANTS.UTILITY_TOKEN_SYMBOL}":1,"ALPHA":2,"BETA":3,"UNTAMED":4} }`
        )
      );
      ...
      assert.equal(
        JSON.stringify(params.editionMapping),
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "updateParams",
          `{ "wrongKey": {"${CONSTANTS.UTILITY_TOKEN_SYMBOL}":1,"ALPHA":2,"BETA":3,"UNTAMED":4} }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      assert.equal(
        JSON.stringify(params.editionMapping),
        `{"${CONSTANTS.UTILITY_TOKEN_SYMBOL}":1,"ALPHA":2,"BETA":3}`
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nft",
          "updateParams",
          '{ "nftCreationFee": "5", "dataPropertyCreationFee": "5" }'
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "nft",
          "updateParams",
          `{ "nftCreationFee": "5", "dataPropertyCreationFee": "5", "nftIssuanceFee": {"${CONSTANTS.UTILITY_TOKEN_SYMBOL}":"0.1"} }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transferToContract",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"crittermanager", "quantity":"1000", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": 10 }`
        )
      );
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"aggroed", "quantity":"9", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transferToContract",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"crittermanager", "quantity":"39.999", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": false, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": 10 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "GAMMA", "packs": 10 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": 0 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": 11 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": 3.14159 }`
        )
      );
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": "notanumber" }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      transactions.push(
        new Transaction(
          ...
          "tokens",
          "transfer",
          `{ "symbol":"${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "to":"aggroed", "quantity":"1", "isSignedWithActiveKey":true }`
        )
      );
      transactions.push(
        new Transaction(
      ...
      assert.equal(
        ...
        "packs must be an integer between 1 and 10"
      );
      assert.equal(
      ...
      assert.equal(
        ...
        "you must have enough pack tokens"
      );
      assert.equal(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "hatch",
          `{ "isSignedWithActiveKey": true, "packSymbol": "${CONSTANTS.UTILITY_TOKEN_SYMBOL}", "packs": 1 }`
        )
      );
      transactions.push(
        new Transaction(
    ...
    new Promise(async (resolve) => {
      ...
      transactions.push(
        new Transaction(
          ...
          "crittermanager",
          "updateName",
          '{ "id": "2", "name": "tooooooooooooolllllllooooooooooooonnnnnnnnnnnnnggggggggggggggggg" }'
        )
      );
      transactions.push(
        new Transaction(
      ...
      assert.equal(
        JSON.parse(transactionsBlock1[12].logs).errors[0],
        "invalid name: letters, numbers, whitespaces only, max length of 25"
      );
      assert.equal(
        JSON.parse(transactionsBlock1[14].logs).errors[0],
        "must be the token holder"
      );
